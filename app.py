...
def cache_objects():
    ...
    return mp_drawing, mp_drawing_styles, hands, model, index_to_label
...
if __name__ == '__main__':
    ...
    # load objects for execution 
    mp_hands = mp.solutions.hands
    mp_drawing, mp_drawing_styles, hands, model, index_to_label = cache_objects()
